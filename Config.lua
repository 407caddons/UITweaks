...
function addonTable.Config.Initialize()
    ...
    if not configWindow then
        ...
        _G[thresholdSlider:GetName() .. 'Text']:SetText("Repair Reminder: " .. (UIThingsDB.vendor.repairThreshold or 20) .. "%")
        ...
        _G[vendorFontSizeSlider:GetName() .. 'Text']:SetText("Alert Size: " .. UIThingsDB.vendor.fontSize)
        ...
        vendorFontSizeSlider:SetScript("OnValueChanged", function(self, value)
            ...
            _G[self:GetName() .. 'Text']:SetText("Alert Size: " .. value)
            if addonTable.Vendor.UpdateSettings then addonTable.Vendor.UpdateSettings() end
        end)
        ...
        _G[fontSizeSlider:GetName() .. 'Text']:SetText("Size: " .. UIThingsDB.combat.fontSize)
