...
local function OnEvent(self, event, ...)
    if event == "ADDON_LOADED" and ... == addonName then
        ...
        local DEFAULTS = {
            ...
            encounterBars = {
                enabled = false, timeline = true, pulls = true, breaks = true,
                locked = true, growUp = false, hideTimeline = true,
                width = 280, height = 24, spacing = 4, maxBars = 8,
                font = "Fonts\\FRIZQT__.TTF", fontSize = 12,
                color = { r = 0.15, g = 0.7, b = 0.6 },
                urgentColor = { r = 1, g = 0.35, b = 0.2 },
                timerColor = { r = 0.35, g = 0.6, b = 1 },
                countdown = false, timerCountdown = true,
                recordedCountdown = true,
                timerStartSound = true,
                pullSeconds = 10, breakMinutes = 5, shortCommands = false,
                emphasize = false, emphasizeThreshold = 10,
                emphasizeWidth = 320, emphasizeHeight = 30, emphasizeFontSize = 16,
                emphasizeColor = { r = 1, g = 0.55, b = 0.15 },
                indicators = true, dueNow = true,
                ...
                timerPos = { point = "CENTER", x = 0, y = 180 },
            },
            buffAlerts = {
                enabled = true,
